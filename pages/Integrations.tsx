...
const Integrations: React.FC = () => {
   ...
   const integrationScenarios = [
      {
         title: "Product & Packaging Hub ~ SAP Synchronization",
         desc: "Governed synchronization between Microsoft 365 workflows and SAP Product & Packaging Hub using secure APIs and OData.",
         howItWorks: [
