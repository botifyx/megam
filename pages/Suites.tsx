      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 mb-16 border-b border-slate-100 dark:border-white/10 pb-16 transition-all">
        <div className="space-y-6">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] font-mono font-bold text-brand-primary uppercase tracking-[0.5em] whitespace-nowrap">Integrated Specification v4.2</span>
          </div>
          <h1 className="text-5xl lg:text-6xl font-black text-slate-900 dark:text-white tracking-tighter leading-none animate-hero-text-focus">
            {suite.title}
          </h1>
          <div className="flex items-center gap-3">
              ...
              {PRODUCT_SUITES.map((suite, idx) => {
                ...
                return (
                  <button
                    ...
                    className={`group relative w-full text-left p-6 rounded-[2.5rem] border transition-all duration-500 overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:ring-offset-2 dark:focus-visible:ring-offset-brand-dark ${isActive
